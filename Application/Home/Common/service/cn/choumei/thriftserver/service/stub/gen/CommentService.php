...
interface CommentServiceIf extends \cn\choumei\thriftserver\service\stub\gen\BaseServiceIf {
  ...
  /**
   * @param \cn\choumei\thriftserver\service\stub\gen\PushThrift[] $pushs
   * @return \cn\choumei\thriftserver\service\stub\gen\InsertRet db insert操作的类型
   * 
   */
  public function addPushs(array $pushs);
  /**
   * @param int $userId
   * @param int $page
   * @param int $pageSize
   * @return \cn\choumei\thriftserver\service\stub\gen\GetUserPushMsgRet
   */
  public function getUserPushMsg($userId, $page, $pageSize);
  /**
   * @param int $userId
   * @param int[] $msgIdList
   * @param string $status
   ...
   * 
   */
  public function updateUserPushMsg($userId, array $msgIdList, $status);
  /**
   * @param int $userId
   * @param int[] $isReadList
   * @param int[] $delSysList
   * @return \cn\choumei\thriftserver\service\stub\gen\GetUnReadPushMsgRet
   */
  public function getUnReadPushMsg($userId, array $isReadList, array $delSysList);
  /**
   * @param int $page
   * @param int $pageSize
   * @param int[] $lists
   * @return \cn\choumei\thriftserver\service\stub\gen\GetSysPushMsgRet
   */
  public function getSysPushMsg($page, $pageSize, array $lists);
  /**
   * @param int $id
   * @return \cn\choumei\thriftserver\service\stub\gen\GetPushConfigByIdRet
   */
  public function getPushConfigById($id);
}
...
class CommentServiceClient extends \cn\choumei\thriftserver\service\stub\gen\BaseServiceClient implements \cn\choumei\thriftserver\service\stub\gen\CommentServiceIf {
  ...
  public function addPushs(array $pushs)
  {
    $this->send_addPushs($pushs);
    return $this->recv_addPushs();
  }

  public function send_addPushs(array $pushs)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\CommentService_addPushs_args();
    $args->pushs = $pushs;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'addPushs', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('addPushs', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_addPushs()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\CommentService_addPushs_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\CommentService_addPushs_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("addPushs failed: unknown result");
  }

  public function getUserPushMsg($userId, $page, $pageSize)
  {
    $this->send_getUserPushMsg($userId, $page, $pageSize);
    return $this->recv_getUserPushMsg();
  }

  public function send_getUserPushMsg($userId, $page, $pageSize)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getUserPushMsg_args();
    $args->userId = $userId;
    $args->page = $page;
    $args->pageSize = $pageSize;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getUserPushMsg', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getUserPushMsg', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getUserPushMsg()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\CommentService_getUserPushMsg_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getUserPushMsg_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("getUserPushMsg failed: unknown result");
  }

  public function updateUserPushMsg($userId, array $msgIdList, $status)
  {
    $this->send_updateUserPushMsg($userId, $msgIdList, $status);
    return $this->recv_updateUserPushMsg();
  }

  public function send_updateUserPushMsg($userId, array $msgIdList, $status)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\CommentService_updateUserPushMsg_args();
    $args->userId = $userId;
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'updateUserPushMsg', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('updateUserPushMsg', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_updateUserPushMsg()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\CommentService_updateUserPushMsg_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\CommentService_updateUserPushMsg_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("updateUserPushMsg failed: unknown result");
  }

  public function getUnReadPushMsg($userId, array $isReadList, array $delSysList)
  {
    $this->send_getUnReadPushMsg($userId, $isReadList, $delSysList);
    return $this->recv_getUnReadPushMsg();
  }

  public function send_getUnReadPushMsg($userId, array $isReadList, array $delSysList)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getUnReadPushMsg_args();
    $args->userId = $userId;
    $args->isReadList = $isReadList;
    $args->delSysList = $delSysList;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getUnReadPushMsg', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getUnReadPushMsg', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getUnReadPushMsg()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\CommentService_getUnReadPushMsg_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getUnReadPushMsg_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("getUnReadPushMsg failed: unknown result");
  }

  public function getSysPushMsg($page, $pageSize, array $lists)
  {
    $this->send_getSysPushMsg($page, $pageSize, $lists);
    return $this->recv_getSysPushMsg();
  }

  public function send_getSysPushMsg($page, $pageSize, array $lists)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getSysPushMsg_args();
    $args->page = $page;
    $args->pageSize = $pageSize;
    $args->lists = $lists;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getSysPushMsg', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getSysPushMsg', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getSysPushMsg()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\CommentService_getSysPushMsg_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getSysPushMsg_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("getSysPushMsg failed: unknown result");
  }

  public function getPushConfigById($id)
  {
    $this->send_getPushConfigById($id);
    return $this->recv_getPushConfigById();
  }

  public function send_getPushConfigById($id)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getPushConfigById_args();
    $args->id = $id;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getPushConfigById', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getPushConfigById', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getPushConfigById()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\CommentService_getPushConfigById_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\CommentService_getPushConfigById_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("getPushConfigById failed: unknown result");
  }
...
class CommentService_addPushs_args extends TBase {
  static $_TSPEC;

  /**
   * @var \cn\choumei\thriftserver\service\stub\gen\PushThrift[]
   */
  public $pushs = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\cn\choumei\thriftserver\service\stub\gen\PushThrift',
            ),
          ),
        );
    }
  ...
  public function getName() {
    return 'CommentService_addPushs_args';
  }

  public function read($input)
  {
    return $this->_read('CommentService_addPushs_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_addPushs_args', self::$_TSPEC, $output);
  }

}

class CommentService_addPushs_result extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'CommentService_addPushs_result';
  }

  public function read($input)
  {
    return $this->_read('CommentService_addPushs_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_addPushs_result', self::$_TSPEC, $output);
  }

}

class CommentService_getUserPushMsg_args extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'CommentService_getUserPushMsg_args';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getUserPushMsg_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getUserPushMsg_args', self::$_TSPEC, $output);
  }

}

class CommentService_getUserPushMsg_result extends TBase {
  static $_TSPEC;

  /**
   * @var \cn\choumei\thriftserver\service\stub\gen\GetUserPushMsgRet
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\cn\choumei\thriftserver\service\stub\gen\GetUserPushMsgRet',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'CommentService_getUserPushMsg_result';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getUserPushMsg_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getUserPushMsg_result', self::$_TSPEC, $output);
  }

}

class CommentService_updateUserPushMsg_args extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'CommentService_updateUserPushMsg_args';
  }

  public function read($input)
  {
    return $this->_read('CommentService_updateUserPushMsg_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_updateUserPushMsg_args', self::$_TSPEC, $output);
  }

}

class CommentService_updateUserPushMsg_result extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'CommentService_updateUserPushMsg_result';
  }

  public function read($input)
  {
    return $this->_read('CommentService_updateUserPushMsg_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_updateUserPushMsg_result', self::$_TSPEC, $output);
  }

}

class CommentService_getUnReadPushMsg_args extends TBase {
  static $_TSPEC;
   ...
   * @var int[]
   */
  public $isReadList = null;
  /**
   * @var int[]
   */
  public $delSysList = null;
  ...
  public function getName() {
    return 'CommentService_getUnReadPushMsg_args';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getUnReadPushMsg_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getUnReadPushMsg_args', self::$_TSPEC, $output);
  }

}

class CommentService_getUnReadPushMsg_result extends TBase {
  static $_TSPEC;

  /**
   * @var \cn\choumei\thriftserver\service\stub\gen\GetUnReadPushMsgRet
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\cn\choumei\thriftserver\service\stub\gen\GetUnReadPushMsgRet',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'CommentService_getUnReadPushMsg_result';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getUnReadPushMsg_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getUnReadPushMsg_result', self::$_TSPEC, $output);
  }

}

class CommentService_getSysPushMsg_args extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'CommentService_getSysPushMsg_args';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getSysPushMsg_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getSysPushMsg_args', self::$_TSPEC, $output);
  }

}

class CommentService_getSysPushMsg_result extends TBase {
  static $_TSPEC;

  /**
   * @var \cn\choumei\thriftserver\service\stub\gen\GetSysPushMsgRet
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\cn\choumei\thriftserver\service\stub\gen\GetSysPushMsgRet',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'CommentService_getSysPushMsg_result';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getSysPushMsg_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getSysPushMsg_result', self::$_TSPEC, $output);
  }

}

class CommentService_getPushConfigById_args extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'CommentService_getPushConfigById_args';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getPushConfigById_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getPushConfigById_args', self::$_TSPEC, $output);
  }

}

class CommentService_getPushConfigById_result extends TBase {
  static $_TSPEC;

  /**
   * @var \cn\choumei\thriftserver\service\stub\gen\GetPushConfigByIdRet
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\cn\choumei\thriftserver\service\stub\gen\GetPushConfigByIdRet',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'CommentService_getPushConfigById_result';
  }

  public function read($input)
  {
    return $this->_read('CommentService_getPushConfigById_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('CommentService_getPushConfigById_result', self::$_TSPEC, $output);
  }
