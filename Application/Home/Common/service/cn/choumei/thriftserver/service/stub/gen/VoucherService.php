...
interface VoucherServiceIf extends \cn\choumei\thriftserver\service\stub\gen\BaseServiceIf {
   ...
   * @return \cn\choumei\thriftserver\service\stub\gen\VouchersRet
   */
  public function getVouchersExpiring($rangeBegin, $rangeEnd, $page, $size);
}
...
class VoucherServiceClient extends \cn\choumei\thriftserver\service\stub\gen\BaseServiceClient implements \cn\choumei\thriftserver\service\stub\gen\VoucherServiceIf {
  ...
  public function getVouchersExpiring($rangeBegin, $rangeEnd, $page, $size)
  {
    $this->send_getVouchersExpiring($rangeBegin, $rangeEnd, $page, $size);
    return $this->recv_getVouchersExpiring();
  }

  public function send_getVouchersExpiring($rangeBegin, $rangeEnd, $page, $size)
  {
    $args = new \cn\choumei\thriftserver\service\stub\gen\VoucherService_getVouchersExpiring_args();
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getVouchersExpiring', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getVouchersExpiring', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getVouchersExpiring()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\cn\choumei\thriftserver\service\stub\gen\VoucherService_getVouchersExpiring_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \cn\choumei\thriftserver\service\stub\gen\VoucherService_getVouchersExpiring_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("getVouchersExpiring failed: unknown result");
  }
...
class VoucherService_getVouchersExpiring_args extends TBase {
  static $_TSPEC;

  /**
   * @var int
   */
  public $rangeBegin = null;
  /**
   * @var int
   */
  ...
  public function getName() {
    return 'VoucherService_getVouchersExpiring_args';
  }

  public function read($input)
  {
    return $this->_read('VoucherService_getVouchersExpiring_args', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('VoucherService_getVouchersExpiring_args', self::$_TSPEC, $output);
  }

}

class VoucherService_getVouchersExpiring_result extends TBase {
  static $_TSPEC;
  ...
  public function getName() {
    return 'VoucherService_getVouchersExpiring_result';
  }

  public function read($input)
  {
    return $this->_read('VoucherService_getVouchersExpiring_result', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('VoucherService_getVouchersExpiring_result', self::$_TSPEC, $output);
  }
